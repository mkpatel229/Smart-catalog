...
export class ProductListComponent {
    rate: number;
    pageTitle = 'Smart Catalog';
    imageWidth = 120;
    imageHeight = 120;
    imageMargin = 12;
    showImage = false;
    listFilter: string;
    manufacturers = [{ 'id': 'GCP', 'checked': false },
    { 'id': 'Azure', 'checked': false },
    { 'id': 'AWS', 'checked': false }
    ];
    os = [{ 'id': 'Linux', 'checked': false },
    ...
    // Invoked when user clicks on Details button
